...
```
curl -sL https://github.com/gostevedore/stevedore/releases/download/v0.10.3/stevedore_0.10.3_Linux-x86_64.tar.gz > stevedore_0.10.3_Linux-x86_64.tar.gz
```

2. Untar the package
```
tar xzfv stevedore_0.10.3_Linux-x86_64.tar.gz
```
