...
```
curl -sL https://github.com/gostevedore/stevedore/releases/download/v{{<param "release_version">}}/stevedore_{{<param "release_version">}}_Linux-x86_64.tar.gz > stevedore_{{<param "release_version">}}_Linux-x86_64.tar.gz
```

2. Untar the package
```
tar xzfv stevedore_{{<param "release_version">}}_Linux-x86_64.tar.gz
```
