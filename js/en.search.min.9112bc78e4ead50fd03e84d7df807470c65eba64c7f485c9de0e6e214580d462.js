...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);loadScript('/documentation/js/groupBy-62b30ac391.min.js');loadScript('/documentation/js/flexsearch-ad47a5e1ee.min.js',function(){const indexCfg={};const dataUrl="/documentation/en.search-data.min.json"
